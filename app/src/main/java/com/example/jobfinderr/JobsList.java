...
public class JobsList extends AppCompatActivity implements JobsListener{

    private Button buttonAddToInterestedJobs;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonAddToInterestedJobs=findViewById(R.id.buttonAddToInterestedJobs);
